...
def main():
    ...
    object_key  = 'compound-historical-dec-20.csv'
    ...
    transactionResponse                   = {"result":{"COMPOUND":{"data":{}}}}
    transactionResponse["result"]["COMPOUND"]["context"] = {}
    transactionResponse["result"]["COMPOUND"]["context"]["errors"] = errors
    ...
    for row in df.iterrows():
        ...
        transactionResponse["result"]["COMPOUND"]["data"].append(temp)
